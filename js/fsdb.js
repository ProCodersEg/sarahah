        ...
        if (notificationsOn === true && userFCMToken) {
          const notification = {
            ...
            notification: {
              ...
              // channel_id is defined in your Notification Channel on the Android side
              channel_id: "channel_id", 
              icon: "icon", // This should match your drawable resource name
            },
            data: {
              image: "https://www.sarhne.com/blog/media/2021-11-27-2149488.webp", // This is data payload
              additionalData: "any additional data you need" // Any other data you want to send
            }
          };
